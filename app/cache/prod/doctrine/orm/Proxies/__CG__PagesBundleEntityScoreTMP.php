 ...
 */
class ScoreTMP extends \PagesBundle\Entity\ScoreTMP implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'id', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'problem', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'k', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'l', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'r', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'n', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'g', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'b', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 's', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'rn', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'rg', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'rb', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'nb', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'ng', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'gb', '' . "\0" . 'PagesBundle\\Entity\\ScoreTMP' . "\0" . 'file_name');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ScoreTMP $proxy) {
